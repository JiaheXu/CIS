...
def em_tracking( data_dir , data_type , letter  , output = 1 ):

    empivot = glob.glob(data_dir + 'pa1-' + data_type + '-' + letter + '-empivot.txt')
    # print(empivot)
    ...
    ans = pivot_calibration( empivot_data ,Ng, Nframes)
