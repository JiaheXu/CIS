...
def distort_calibration( data_dir ,pa ,data_type , letter  , output = 1 ):
    ...
    calreadings = glob.glob(data_dir + pa + data_type + '-' + letter + '-calreadings.txt')
    ...
    #for i in range(1):
        ...
        C_new = calreadings_data[start_index + ND + NA : start_index + ND + NA + NC , :]
        C = np.vstack( ( C , C_new ) )    
